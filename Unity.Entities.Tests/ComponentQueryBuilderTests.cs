...
{
    class ComponentQueryBuilderTestFixture : ECSTestsFixture
    {
    ...
    class ComponentQueryBuilderTests : ComponentQueryBuilderTestFixture
    {
        [DisableAutoCreation]//, UsedImplicitly]
        ...
        public void Equals_WithMatchedButDifferentlyConstructedBuilders_ReturnsTrue()
        {
            ...
            var builder1 = new ComponentQueryBuilder(TestSystem)
