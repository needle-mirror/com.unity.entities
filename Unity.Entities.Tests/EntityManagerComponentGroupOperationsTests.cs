...
namespace Unity.Entities.Tests
{
    class EntityManagerComponentGroupOperationsTests : ECSTestsFixture
    {
        ...
        public void AddRemoveChunkComponentWithGroupWorks()
        {
            ...
            var group1 = m_Manager.CreateComponentGroup(ComponentType.ReadWrite<EcsTestData>());
            ...
            var group2 = m_Manager.CreateComponentGroup(ComponentType.ReadWrite<EcsTestData2>(), ComponentType.ChunkComponent<EcsTestData3>());
        ...
        public void AddRemoveSharedComponentWithGroupWorks()
        {
            ...
            var group2 = m_Manager.CreateComponentGroup(ComponentType.ReadWrite<EcsTestData2>(), ComponentType.ReadWrite<EcsTestSharedComp>());
        ...
        public static ComponentType[] GetTestTypes()
        {
            TypeManager.Initialize();
            return new ComponentType[] { typeof(EcsTestTag), typeof(EcsTestData4), ComponentType.ChunkComponent<EcsTestData4>(), typeof(EcsTestSharedComp) };
        }
        ...
        public void AddRemoveAnyComponentWithGroupWorksWith([ValueSource(nameof(GetTestTypes))] ComponentType type)
        {
            ...
            var group2 = m_Manager.CreateComponentGroup(ComponentType.ReadWrite<EcsTestData2>(), type);
        ...
        public void RemoveAnyComponentWithGroupIgnoresChunksThatDontHaveTheComponent([ValueSource(nameof(GetTestTypes))] ComponentType type)
        {
            ...
            m_Manager.RemoveComponent(m_Manager.UniversalGroup, type);

            Assert.AreEqual(0, m_Manager.CreateComponentGroup(type).CalculateLength());
        }
        ...
        public void AddRemoveComponentWithGroupPreservesChangeVersions()
        {
            ...
            m_Manager.AddSharedComponentData(m_Manager.UniversalGroup, new EcsTestSharedComp(1));
            ...
            m_Manager.RemoveComponent(m_Manager.UniversalGroup, typeof(EcsTestSharedComp2));
            ...
            m_Manager.RemoveComponent(m_Manager.UniversalGroup, typeof(EcsTestSharedComp));
