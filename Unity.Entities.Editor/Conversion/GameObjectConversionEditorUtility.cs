...
namespace Unity.Entities.Editor
{
    ...
    static class GameObjectConversionEditorUtility
    {
        ...
        public static GameObjectConversionResultStatus GetGameObjectConversionResultStatus(GameObject gameObject)
        {
            ...
            bool hasConvertToEntityComponent = gameObject.TryGetComponent<ConvertToEntity>(out var convertToEntityOnCurrentGO);

            return (hasConvertToEntityComponent && convertToEntityOnCurrentGO.enabled)
