...
namespace Unity.Entities.SourceGen.LambdaJobs
{
    ...
    interface IAspectParamDescription : IParamDescription
    {
    }
    ...
    class LambdaParamDescription_Component : LambdaParamDescription, IComponentParamDescription, IParamRequireUpdate
    {
        ...
        internal override string FieldInGeneratedJobChunkType() => $@"{(Syntax.IsReadOnly() ? "[Unity.Collections.ReadOnly] " : "")}public Unity.Entities.ComponentTypeHandle<{TypeSymbol.ToFullName()}> __{Syntax.Identifier}TypeHandle;";
        ...
        internal override string GetNativeArrayOrAccessor()
        {
            return QueryTypeIsReadOnly()
                ? $@"var {Syntax.Identifier}ArrayPtr = Unity.Entities.InternalCompilerInterface.UnsafeGetChunkNativeArrayReadOnlyIntPtr<{TypeSymbol.ToFullName()}>(chunk, ref __{Syntax.Identifier}TypeHandle);"
                : $@"var {Syntax.Identifier}ArrayPtr = Unity.Entities.InternalCompilerInterface.UnsafeGetChunkNativeArrayIntPtr<{TypeSymbol.ToFullName()}>(chunk, ref __{Syntax.Identifier}TypeHandle);";
        }
        ...
        internal override string FieldAssignmentInGeneratedJobChunkType(LambdaJobDescription lambdaJobDescription) =>
            $@"__{Syntax.Identifier}TypeHandle = {FieldName}";
        ...
        {
            return $@"{FieldName}.Update(ref {description.SystemStateParameterName});";
        }
    }
    ...
    class LambdaParamDescription_ManagedComponent : LambdaParamDescription, IManagedComponentParamDescription
    {
        ...
        internal override string FieldInGeneratedJobChunkType() => $@"public Unity.Entities.ComponentTypeHandle<{TypeSymbol.ToFullName()}> __{Syntax.Identifier}TypeHandle;";
        internal override bool QueryTypeIsReadOnly() => Syntax.IsReadOnly();
    ...
    class LambdaParamDescription_Entity : LambdaParamDescription, IParamRequireUpdate
    {
        ...
        internal override string FieldInGeneratedJobChunkType() => $@"[Unity.Collections.ReadOnly] public Unity.Entities.EntityTypeHandle __{Syntax.Identifier}TypeHandle;";
        ...
        internal override string FieldAssignmentInGeneratedJobChunkType(LambdaJobDescription lambdaJobDescription)
        {
            return $@"__{Syntax.Identifier}TypeHandle = {FieldName}";
        }
        ...
        public string FormatUpdateInvocation(LambdaJobDescription description) => $@"{FieldName}.Update(ref {description.SystemStateParameterName});";
    ...
    class LambdaParamDescription_Aspect : LambdaParamDescription, IAspectParamDescription, IParamRequireUpdate
    {
        ...
        internal override string StructuralChanges_LambdaBodyParameter()
        {
            return $@"{Syntax.GetModifierString()} {Syntax.Identifier}";
        }

        public string FieldName { get; set; }
        bool IParamRequireUpdate.IsReadOnly => QueryTypeIsReadOnly();
        string IParamRequireUpdate.FormatUpdateInvocation(LambdaJobDescription description)
            => $@"{FieldName}.Update(ref {description.SystemStateParameterName});";
    }
