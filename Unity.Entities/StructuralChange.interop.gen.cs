...
namespace Unity.Entities
{
     unsafe partial struct StructuralChange
    {
        ...
        public  static void AddComponentEntitiesBatch (EntityComponentStore* entityComponentStore, UnsafeList<EntityBatchInChunk>* entityBatchList, int typeIndex)
        {
#if !UNITY_IOS
            if (UseDelegate())
            {
        ...
        {
            _AddComponentEntitiesBatch((EntityComponentStore*)entityComponentStore, (UnsafeList<EntityBatchInChunk>*)entityBatchList, typeIndex);
        }

        [BurstDiscard]
        private static void _forward_mono_AddComponentEntitiesBatch(EntityComponentStore* entityComponentStore, UnsafeList<EntityBatchInChunk>* entityBatchList, int typeIndex)
        {
            Managed._bfp_AddComponentEntitiesBatch((IntPtr) entityComponentStore, (IntPtr) entityBatchList, typeIndex);
        }
#endif

        public  static void AddComponentsEntitiesBatch (EntityComponentStore* entityComponentStore, UnsafeList<EntityBatchInChunk>* entityBatchList, ref ComponentTypes types)
        {
#if !UNITY_IOS
            if (UseDelegate())
            {
        ...
        {
            _AddComponentsEntitiesBatch((EntityComponentStore*)entityComponentStore, (UnsafeList<EntityBatchInChunk>*)entityBatchList, ref types);
        }

        [BurstDiscard]
        private static void _forward_mono_AddComponentsEntitiesBatch(EntityComponentStore* entityComponentStore, UnsafeList<EntityBatchInChunk>* entityBatchList, ref ComponentTypes types)
        {
        ...
        public  static void RemoveComponentEntitiesBatch (EntityComponentStore* entityComponentStore, UnsafeList<EntityBatchInChunk>* entityBatchList, int typeIndex)
        {
#if !UNITY_IOS
            if (UseDelegate())
            {
        ...
        {
            _RemoveComponentEntitiesBatch((EntityComponentStore*)entityComponentStore, (UnsafeList<EntityBatchInChunk>*)entityBatchList, typeIndex);
        }

        [BurstDiscard]
        private static void _forward_mono_RemoveComponentEntitiesBatch(EntityComponentStore* entityComponentStore, UnsafeList<EntityBatchInChunk>* entityBatchList, int typeIndex)
        {
            Managed._bfp_RemoveComponentEntitiesBatch((IntPtr) entityComponentStore, (IntPtr) entityBatchList, typeIndex);
        }
#endif

        public  static void RemoveComponentsEntitiesBatch (EntityComponentStore* entityComponentStore, UnsafeList<EntityBatchInChunk>* entityBatchList, ref ComponentTypes types)
        {
#if !UNITY_IOS
            if (UseDelegate())
            {
        ...
        {
            _RemoveComponentsEntitiesBatch((EntityComponentStore*)entityComponentStore, (UnsafeList<EntityBatchInChunk>*)entityBatchList, ref types);
        }

        [BurstDiscard]
        private static void _forward_mono_RemoveComponentsEntitiesBatch(EntityComponentStore* entityComponentStore, UnsafeList<EntityBatchInChunk>* entityBatchList, ref ComponentTypes types)
        {
