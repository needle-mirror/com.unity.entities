...
{
    public partial struct ComponentQueryBuilder
    {
        ...
        internal ComponentQueryBuilder(ComponentSystem system)
        {
            m_System = system;
        ...
        internal bool ShallowEquals(ref ComponentQueryBuilder other)
        {
            #if ENABLE_UNITY_COLLECTIONS_CHECKS
            if (!ReferenceEquals(m_System, other.m_System))
                throw new InvalidOperationException($"Suspicious comparison of {nameof(ComponentQueryBuilder)}s with different {nameof(ComponentSystem)}s");
            #endif
        ...
        public ComponentQueryBuilder With(ComponentGroup componentGroup)
        {
            #if ENABLE_UNITY_COLLECTIONS_CHECKS
        ...
        // see ComponentQueryBuilder.tt for the template that is converted into ComponentQueryBuilder.gen.cs,
        ...
        unsafe ComponentGroup ResolveComponentGroup(int* delegateTypeIndices, int delegateTypeCount)
        {
            ...
            var cache = m_System.GetOrCreateComponentQueryCache();
