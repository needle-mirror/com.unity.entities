...
namespace Unity.Transforms
{
    ...
    public static class Helpers
    {
        ...
        /// <returns>
        /// A quaternion containing the transformed rotation. This quaternion will not necessarily be normalized.
        /// </returns>
        ...
        /// - When one entity's transform needs to "track" another's in world-space, and the targeting entity and/or the
