...
namespace UnityEngine.Entities.Tests
{
    class ConversionMappingTests : ECSTestsFixture
    {
        ...
        public override void Setup()
        {
            ...
            mappingSystem = World.CreateManager<GameObjectConversionMappingSystem>(dstWorld, default(Unity.Entities.Hash128), GameObjectConversionUtility.ConversionFlags.None);
        }
