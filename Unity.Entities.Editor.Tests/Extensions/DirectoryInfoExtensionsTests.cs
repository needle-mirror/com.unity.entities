...
namespace Unity.Entities.Editor.Tests
{
    class DirectoryInfoExtensionsTests
    {
        ...
        public void SetUp()
        {
            ...
            m_RandomFileName = Path.GetRandomFileName();
            m_RootTestEditorDirectory = new DirectoryInfo(appPathFullName + $"/Assets/{m_RandomFileName}");
            m_RootTestDirectory = new DirectoryInfo(appPathFullName + $"/Assets/{m_RandomFileName}/Extensions");
        ...
        {
            var directory = new DirectoryInfo(Application.dataPath).Parent.Combine("Assets", m_RandomFileName, "Extensions");
