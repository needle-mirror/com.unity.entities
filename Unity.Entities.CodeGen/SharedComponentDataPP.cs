...
{
    internal class IRefCountedPP : EntitiesILPostProcessor
    {
        /*
         * Generate static forwarders for both hybrid and dots runtime, just like isystem, and
         * transfer burstcompile attributes, and add [Preserve] and [MonoPInvokeCallback] attributes. 
         *
         * For dots runtime, generate a function to register them all and have typemanager generate a call to that.
         *
         * 
         */
                    ...
                    for (int i = 0; i < methodNameArray.Length; ++i)
                    {
                        ...
                        catch (Exception e)
                        {
                            ...
                            if (name == "GetHashCode")
                                continue;
                            Console.WriteLine(
                                $"Signature mismatch in ilpp on type {type} method {name} exception {e.Message}");
                            int j = 0;
 ...
 typeof(MonoPInvokeCallbackAttribute).GetConstructors(BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance);
 ...
 new CustomAttribute(mod.ImportReference(monoPInvokeCallbackAttributeConstructors[0]));
                ...
                methodDef.CustomAttributes.Add(new CustomAttribute(mod.ImportReference(
