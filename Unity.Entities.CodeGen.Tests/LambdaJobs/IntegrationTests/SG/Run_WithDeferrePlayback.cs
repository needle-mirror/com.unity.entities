...
#endif
    [TestFixture]
    class Run_WithDeferredPlayback : LambdaJobsSourceGenerationIntegrationTest
    {
        private const string Code =
            ...
            public partial class Run_WithDeferredPlayback : SystemBase
            {
        ...
        [Test]
        public void Run_WithDeferredPlaybackTest()
        {
            RunTest(Code, new GeneratedType {Name = "Run_WithDeferredPlayback"});
        }
    }
}
