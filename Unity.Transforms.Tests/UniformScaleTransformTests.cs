...
{
    [TestFixture]
    partial class UniformScaleTransformTests : ECSTestsFixture
    {
        ...
        static UniformScaleTransform GetTestTransform1()
        {
        ...
        static UniformScaleTransform GetTestTransform2()
        {
        ...
        [Test]
        public void UST_Identity()
        {
            var transform = UniformScaleTransform.Identity;
            Assert.IsTrue(transform.ToMatrix().Equals(float4x4.identity));
        }

        [Test]
        public void UST_Inverse()
        {
        ...
        [Test]
        public void UST_TransformTransform()
        {
        ...
        [Test]
        public void UST_InverseTransformTransform()
        {
            var transform1 = GetTestTransform1();
            var transform2 = GetTestTransform2();
        ...
        [Test]
        public void UST_TransformPoint()
        {
            var transform = GetTestTransform1();
            var matrix = GetTestMatrix1();
        ...
        [Test]
        public void UST_InverseTransformPoint()
        {
            var transform = GetTestTransform1();
            var matrix = GetTestMatrix1();
            var point = new float3(1, 2, 3);
        ...
        [Test]
        public void UST_TransformDirection()
        {
            var transform = GetTestTransform1();
        ...
        [Test]
        public void UST_InverseTransformDirection()
        {
            var transform = GetTestTransform1();
            var matrix = GetTestMatrix1NoScale();
            var direction = math.normalize(new float3(1, 2, 3));
        ...
        [Test]
        public void UST_TransformRotation()
        {
            var transform = GetTestTransform1();
            var matrix = GetTestMatrix1NoScale();
        ...
        [Test]
        public void UST_InverseTransformRotation()
        {
            var transform = GetTestTransform1();
            var matrix = GetTestMatrix1NoScale();
            var rotation = quaternion.Euler(math.PI / 4, math.PI / 3, math.PI / 2);
        ...
        [Test]
        public void UST_TransformScale()
        {
            var transform = GetTestTransform1();
            var matrix = GetTestMatrix1();
            var scale = 3.5f;
        ...
        [Test]
        public void UST_InverseTransformScale()
        {
            var transform = GetTestTransform1();
            var matrix = GetTestMatrix1();
            var scale = 3.5f;
        ...
        [Test]
        public void UST_ToInverseMatrix()
        {
            var transform = GetTestTransform1();
            var matrix = GetTestMatrix1();
        ...
        [Test]
        public void UST_FromMatrix()
        {
            var matrix = GetTestMatrix1();
            var transform = UniformScaleTransform.FromMatrix(matrix);
            Assert.IsTrue(AreNearlyEqual(transform.ToMatrix(), matrix, k_Tolerance));
        }

        [Test]
        public void UST_Translate()
        {
            var transform = GetTestTransform1();
            var matrix = GetTestMatrix1();
