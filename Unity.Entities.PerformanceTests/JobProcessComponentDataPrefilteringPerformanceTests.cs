...
namespace Unity.Entities.PerformanceTests
{
    ...
    public sealed class JobProcessComponentDataPrefilteringPerformanceTests
    {
        private World m_PreviousWorld;
        private World m_World;
        private EntityManager m_Manager;

        private struct ProcessJob : IJobProcessComponentData<EcsTestData>
        {
        ...
        public void Prefiltering_SingleArchetype_SingleChunk_Unfiltered()
        {
            ...
            var group = m_Manager.CreateComponentGroup(ComponentType.ReadWrite<EcsTestData>(),ComponentType.ReadWrite<EcsTestData2>());
            ...
            Measure.Method(
                    () =>
                    {
                        var job = new ProcessJob().ScheduleGroup(group);
                        job.Complete();
                    })
